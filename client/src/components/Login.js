      ...
      <div className="login-card">
        ...
        <form onSubmit={handleSubmit} className="login-form">
          <div className="form-group">
            ...
            setError('');
        }} placeholder="Enter username" disabled={isLoading} autoFocus className="form-input"/>
          </div>
          ...
          <div className="form-group">
            ...
            setError('');
        }} placeholder="Enter password" disabled={isLoading} className="form-input"/>
              <button type="button" className="password-toggle" onClick={() => setShowPassword(!showPassword)} disabled={isLoading} title={showPassword ? 'Hide password' : 'Show password'}>
          ...
          <button type="submit" disabled={isLoading || !username || !password} className="login-button">
